...
exports.uploadGallery = async (req, res) => {
  try {
    ...
    await Gallery.create({
      title_uz: req.body.title_uz, title_ru: req.body.title_ru, title_en: req.body.title_en,
...
exports.deleteGallery = async (req, res) => {
  ...
  if (item) {
    const f = path.join(__dirname, '../public', item.image);
...
exports.createBudget = async (req, res) => {
  try {
    await Budget.create({
      ...
      category_uz: req.body.category_uz, category_ru: req.body.category_ru, category_en: req.body.category_en,
      description_uz: req.body.description_uz, description_ru: req.body.description_ru, description_en: req.body.description_en,
...
exports.saveSettings = async (req, res) => {
  try {
    const keys = ['site_name_uz','site_name_ru','site_name_en','primary_color','secondary_color',
      'bg_type','bg_color','banner_title_uz','banner_title_ru','banner_title_en',
      'banner_subtitle_uz','banner_subtitle_ru','banner_subtitle_en','footer_email','footer_phone','footer_address_uz'];
...
exports.addDirector = async (req, res) => {
  try {
    ...
    await about.save();
    req.flash('success', 'Director added');
  } catch (err) { req.flash('error', err.message); }
  res.redirect('/admin/about');
};
