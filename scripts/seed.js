  ...
  try {
    ...
    if (aboutCount === 0) {
      await About.create({
        ...
        vision_uz: "O'zbekistonning ta'lim tizimida yetakchi o'rinda turish va jahon miqyosida raqobatbardosh bitiruvchilarni tayyorlash.",
        ...
        history_ru: "Президентские школы были основаны в 2019 году по указу Президента Узбекистана.",
        history_en: "Presidential Schools were established in 2019 by decree of the President of Uzbekistan.",
        directors: [
      ...
      console.log('✅ Maktab haqida ma\'lumot saqlandi');
    }
      ...
      await News.create([
        {
          ...
          category: 'science', status: 'published', author: adminUser._id
        },
        {
          ...
          content_uz: "Prezident maktabida yangi o'quv yilining boshlanishi munosabati bilan tantanali bayram bo'lib o'tdi. Bu yil maktabimizga 120 nafar yangi o'quvchi qabul qilindi.",
          content_ru: "В Президентской школе прошёл торжественный праздник в честь начала нового учебного года. В этом году в нашу школу принято 120 новых учеников.",
          content_en: "A grand celebration was held at the Presidential School. This year, 120 new students were admitted.",
          category: 'events', status: 'published', author: adminUser._id
        },
        {
          title_uz: "Robototexnika to'garagi o'quvchilarimiz yangi loyiha ustida ishlamoqda",
          title_ru: "Кружок робототехники работает над новым проектом",
          title_en: "Robotics Club Working on a New Breakthrough Project",
          ...
          content_uz: "Maktabimizning robototexnika to'garagi a'zolari sun'iy intellektga asoslangan yangi loyiha ustida faol ishlashmoqda. O'quvchilarimiz Python va Arduino texnologiyalaridan foydalanib, mustaqil harakatlanuvchi robot yaratmoqdalar.",
          content_ru: "Члены кружка робототехники нашей школы активно работают над новым проектом на основе искусственного интеллекта.",
          content_en: "Members of our school robotics club are actively working on a new AI-based project using Python and Arduino.",
          category: 'science', status: 'published', author: adminUser._id
        }
      ]);
      console.log('✅ Namuna yangiliklar yaratildi');
    }
